        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          {SERVICES.map((service, index) => (
            ...
            >
              ...
              <button className="inline-flex items-center gap-3 font-black text-terracotta group-hover:gap-5 transition-all">
        ...
        <div className="mx-auto max-w-[1400px] px-8 lg:px-12">
          <div className="flex flex-col lg:flex-row items-center gap-20">
            ...
            <div className="w-full lg:w-1/2">
              <span className="text-terracotta font-black uppercase tracking-widest text-sm block mb-4">Interplus Method</span>
              <h2 className="text-4xl lg:text-6xl font-black tracking-tight text-slate-900 mb-10 leading-tight">
                Tieto, taito ja tulevaisuus samassa paketissa.
              </h2>
              <div className="space-y-10">
                <div className="flex gap-6">
                  ...
                  <div>
                    <h4 className="text-xl font-black text-slate-900 mb-2">Suora asiantuntijuus</h4>
                    <p className="text-slate-600 font-medium leading-relaxed">
                      Tiimimme jäsenet ovat itse kokeneet kotoutumispolun ja hallitsevat prosessin ammattilaisina.
                    </p>
                  </div>
                </div>
                <div className="flex gap-6">
                  ...
                  <div>
                    <h4 className="text-xl font-black text-slate-900 mb-2">Kielimuureja ei ole</h4>
                    <p className="text-slate-600 font-medium leading-relaxed">
                      Tarjoamme palveluita yli 20 eri kielellä, varmistaen että jokainen tulee kuulluksi.
                    </p>
                  </div>
                </div>
                <div className="flex gap-6">
                  ...
                  <div>
                    <h4 className="text-xl font-black text-slate-900 mb-2">Modernit työkalut</h4>
                    <p className="text-slate-600 font-medium leading-relaxed">
                      Hyödynnämme uusimpia pedagogisia menetelmiä ja lämminhenkistä teknologiaa.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="relative overflow-hidden rounded-[3.5rem] bg-gradient-to-br from-terracotta to-slate-900 px-8 py-24 text-center text-white shadow-3xl">
          ...
          <div className="relative z-10 flex flex-col items-center gap-12">
            ...
            <div className="flex flex-wrap justify-center gap-6">
              ...
              <button className="h-16 rounded-full bg-white/10 backdrop-blur-md border border-white/20 px-12 text-lg font-black text-white hover:bg-white/20 transition-all">
                Varaa aika
              </button>
            </div>
          </div>
